export const faqs = [
  {
    ...
    answer:
      'No. MedTrek AI is not FDA approved and does not claim to be a regulated medical device. It uses public FDA/openFDA recall data to help users review public safety information more easily.',
  },
  {
    question: 'Is this medical advice?',
    answer:
      'No. MedTrek AI is a public-data review and safety-intelligence tool. It does not diagnose, prescribe, or tell users to start, stop, or change medication. Users should consult a qualified clinician or pharmacist for medical decisions.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Public portals are useful, but they can be hard to review quickly. MedTrek AI adds a cleaner workflow: search, normalized cards, review-priority scoring, plain-English context, source timestamps, and audit details.',
  },
]