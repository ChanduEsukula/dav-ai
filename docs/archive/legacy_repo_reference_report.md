# Archived DAV AI Repository Reference Report

> Archived legacy reference: this file reflects an earlier repository state and earlier project-positioning language. The current public project name and recruiter-facing positioning are in `README.md`. This archived report does not supersede current source code, tests, or documentation.
