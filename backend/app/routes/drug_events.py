...
async def search_drug_events(
    ...
    try:
        ...
        raise HTTPException(
            status_code=503,
            detail={
                "message": "DrugSignal search completed source work but could not persist required audit/provenance metadata.",
                "code": "DRUG_SIGNAL_PROVENANCE_PERSISTENCE_UNAVAILABLE",
            },
        ) from exc
